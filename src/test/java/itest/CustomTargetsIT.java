...
public class CustomTargetsIT extends StandardSelfTest {
    ...
    void shouldBeAbleToDeleteTarget()
        ...
        System.out.println("+++body1 after delete " + body1.encodePrettily());
        System.out.println("+++ size1 after delete " + body1.size());
        MatcherAssert.assertThat(body1, Matchers.notNullValue());
        MatcherAssert.assertThat(body1.size(), Matchers.equalTo(1));
    }
    ...
    void targetShouldNoLongerAppearInListing() throws ExecutionException, InterruptedException {
        ...
        JsonArray body = response.get();
        MatcherAssert.assertThat(body, Matchers.notNullValue());
        System.out.println("+++ outside delete size is: " + body.size());
